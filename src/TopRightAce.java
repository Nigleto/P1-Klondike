...
public class TopRightAce extends Pile {
    ...
    public void addCardPile(Card x, Graphics g){ // this wont work we have to figure out how to move cards by the pile first
...
public void draw(Graphics g, Card c){
    g.drawImage(c.getImage(), this.x, this.y, null);
}
}
